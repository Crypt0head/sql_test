...
{  "color_scheme": "custom",  "label_colors": {    "Загружено": "#1a472a",    "Визит": "#2d5a3d",    "Отклик": "#4a7c59",    "Покупка": "#ffd700",    "кредит": "#1a472a",    "Кредит": "#1a472a",    "прочие": "#ffd700",    "Прочие": "#ffd700",    "Центральный": "#1a472a",    "Северо-Западный": "#2d5a3d",    "Сибирский": "#4a7c59",    "Приволжский": "#6b9b7a",    "Южный": "#ffd700",    "Офис": "#1a472a",    "Интернет-банк": "#2d5a3d",    "Контакт-центр": "#ffd700"  }}
